...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { course_id: @discipline.course_id, name: @discipline.name } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { course_id: @discipline.course_id, name: @discipline.name } }
